...
# Deprecated useThemeChoice

The use of the `useThemeChoice` hook to connect `ThemeSwitch` and ThemeProvider is no longer required and deprecated.
This example just shows that it still works.
