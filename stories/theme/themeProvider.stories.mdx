...
By default, we used the Committed light and dark themes that can be switched using the `choice` prop or the users system preference.
Both the light and dark themes can be customised by supplying customisation functions detailed below.
