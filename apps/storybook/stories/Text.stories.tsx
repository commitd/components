...
export const Inline: Story = {
  render: () => (
    ...
    >
      ...
      <Text>
        This is{' '}
        <Span className={css({ textTransform: 'uppercase' })}>uppercase</Span>{' '}
        text
      </Text>
      <Text>
        This is{' '}
        <Span className={css({ textTransform: 'capitalize' })}>capitals</Span>{' '}
        text
      </Text>
      <Text>
      ...
      <Text>
        This is <Span className={css({ color: '$primary' })}>Primary</Span> text
      </Text>
      <Text>
        This is{' '}
        <Span className={css({ color: '$textSecondary' })}>Secondary</Span> text
      </Text>
      <Text>
