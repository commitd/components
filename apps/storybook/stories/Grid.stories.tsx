 ...
 */
export const AreasShorthand: StoryFn = () => (
  <Grid
    css={{
...
export const GapSame: StoryFn = () => (
  <Grid
    css={{
      gridTemplateColumns: '$9 $9',
      gridAutoRows: 'token(sizes.$9)',
    }}
    gap
  >
    <GridBox />
 ...
 *
 */
export const JustifyItems: StoryFn = () => (
  <Inline>
    <Grid
      css={{
        justifyItems: 'start',
 ...
 */
export const GridAutoFlow: StoryFn = () => (
  <Inline>
    <Grid
      css={{
        gridAutoFlow: 'row',
 ...
 */
export const GridItems: StoryFn = () => (
  <Grid
    css={{
      gridTemplateColumns:
        'token(sizes.$7) token(sizes.$7) token(sizes.$7) token(sizes.$7)',
      gridTemplateRows:
        'token(sizes.$7) token(sizes.$7) token(sizes.$7) token(sizes.$7)',
    }}
  >
...
export const Credit: StoryFn = () => <div />
