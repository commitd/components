...
<Story name="overview">
  <C.ThemeProvider style={{ width: '100%', height: '100%', border: '1px' }}>
    <Background width="1VH">
      <C.Caption>
        <C.Link href="/?path=/docs/components-button--default-story">
          Buttons
        </C.Link>
      </C.Caption>
      <C.Column flexWrap="wrap">
        ...
        <C.Caption>
          <C.Link href="/?path=/docs/components-iconbutton--default-story">
            Icon Buttons
          </C.Link>
        </C.Caption>
        <C.Flex
        ...
        <C.Caption>
          <C.Link href="/?path=/docs/components-badge--default-story">
            Badges
          </C.Link>
        </C.Caption>
        <C.Flex
      ...
      <C.Caption>
        <C.Link href="/?path=/docs/components-avatar--default-story">
          Avatars
        </C.Link>
      </C.Caption>
      <C.Flex
      ...
      >
        <C.Avatar m={1} bg="primary.main" color="primary.contrastText">
          CF
        </C.Avatar>
        <C.Avatar m={1} bg="secondary.main" color="secondary.contrastText">
          SH
        </C.Avatar>
        <C.Avatar m={1}>
          <C.Icons.Folder />
        </C.Avatar>
        <C.Avatar m={1} bg="black" color="white">
          <C.Icons.Pageview />
        </C.Avatar>
        <C.Avatar m={1} bg="primary.light" color="text.primary">
          <C.Icons.Assignment />
        </C.Avatar>
      </C.Flex>
      <C.Caption>
        <C.Link href="/?path=/docs/components-chip--default-story">
          Chips
        </C.Link>
      </C.Caption>
      <C.Flex
      ...
      <C.Caption>
        <C.Link href="/?path=/docs/components-textfield--simple">
          Text Fields
        </C.Link>
      </C.Caption>
      <C.Flex
      ...
      <C.Caption>
        <C.Link href="/?path=/docs/components-checkbox--default-story">
          Checkbox
        </C.Link>
        , <C.Link href="/?path=/docs/components-radio--default-story">
          Radio
        </C.Link> and <C.Link href="/?path=/docs/components-switch--default-story">Switch</C.Link>
      </C.Caption>
      {React.createElement(() => {
      ...
      <C.Caption>
        <C.Link href="/?path=/docs/components-slider--default-story">
          Slider
        </C.Link>
      </C.Caption>
      <C.Flex
      ...
      <C.Caption>
        <C.Link href="/?path=/docs/components-list--default-story">
          Lists
        </C.Link>
      </C.Caption>
      <C.Flex
        ...
        bg="background.defaul"
      >
        <C.Box minWidth={500} m={3} bg="background.paper">
      ...
      <C.Caption>
        <C.Link href="/?path=/docs/components-card--default-story">
          Cards
        </C.Link>
      </C.Caption>
      <C.Flex
      ...
      <C.Caption>
        <C.Link href="/?path=/docs/components-table--default-story">
          Tables
        </C.Link>
      </C.Caption>
      <C.Flex
        ...
        bg="background.default"
      >
        <C.Box m={2} p={3} bg="background.paper">
          <C.Table>
            <C.TableHead>
              <C.TableRow>
      ...
      <C.Caption>
        <C.Link href="/?path=/docs/components-tabs--appbar">Tabs</C.Link>
      </C.Caption>
      <C.Flex
        flexGrow={1}
        flexDirection="column"
      ...
      <C.Caption>
        <C.Link href="/?path=/docs/design-system-typography--typography">
          Typography
        </C.Link>
      </C.Caption>
      <C.Flex
