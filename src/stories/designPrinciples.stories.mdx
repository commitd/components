...
No assumptions are made about the placement of the component but we provide [placement props](/todo) to simplify
...
The margin and padding props take a number from 0 to 6, 0 being no space and 6 is 128px.
