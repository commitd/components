...
export const DocButton: React.FC<MainButtonProps> = (props: MainButtonProps) =>
  null
export const DocCard: React.FC<CardProps> = (props: CardProps) => null

export const DocFlex: React.FC<MainFlexProps> = (props: MainFlexProps) => null
export const DocText: React.FC<MainTextProps> = (props: MainTextProps) => null
